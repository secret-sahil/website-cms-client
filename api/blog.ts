...
export default class Blog {
  static async create(data: any): Promise<any> {
    return await api.post("/api/v1/blog/create", data);
  }
  ...
  static async readOne(id: any): Promise<any> {
    return await api.get(`/api/v1/blog/${id}`);
  }

  static async update(data: any): Promise<any> {
    return await api.patch(`/api/v1/blog/update/${data.id}`, data);
  }

  static async delete(id: any): Promise<any> {
    return await api.delete(`/api/v1/blog/delete/${id}`);
  }
}
