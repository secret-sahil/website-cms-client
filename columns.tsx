...
const Cell = ({ data }: { data: SubCategoriesResponse }) => {
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem asChild>
            <Link href={`/item-subcategories/update/${data.id}`} className="flex items-center">
...
export const columns: ColumnDef<SubCategoriesResponse>[] = [
  {
    accessorKey: "id",
  ...
  {
    accessorKey: "category.division.name",
    ...
    cell: ({ row }) => (
      <span className="bg-green-500/80 text-white px-1 rounded-md">
        {row.original.category.division.name}
      </span>
    ),
  },
  {
