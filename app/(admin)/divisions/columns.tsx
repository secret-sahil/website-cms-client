...
import { DivisionsResponse } from "@/types/divisions";
...
const Cell = ({ data }: { data: DivisionsResponse }) => {
  const { mutate, isPending } = useDeleteDivision();
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem asChild>
            <Link href={`/divisions/update/${data.id}`} className="flex items-center">
...
export const columns: ColumnDef<DivisionsResponse>[] = [
  {
    accessorKey: "id",
