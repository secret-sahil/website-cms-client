...
import { updateSubCategorySchema } from "@/types/subcategories";
...
import { useGetSubCategoryById, useUpdateSubCategory } from "@/hooks/useSubCategories";
...
export default function DataFrom({ id }: { id: number }) {
  ...
  const { data } = useGetSubCategoryById(id);
