...
import { useDeleteStorage } from "@/hooks/useStorages";
...
const Cell = ({ data }: { data: StoragesResponse }) => {
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem asChild>
            <Link href={`/storages/update/${data.id}`} className="flex items-center">
...
export const columns: ColumnDef<StoragesResponse>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <span className="bg-orange-500/80 text-white px-1 rounded-md">{row.original.type}</span>
    ),
  },
  {
    id: "division",
