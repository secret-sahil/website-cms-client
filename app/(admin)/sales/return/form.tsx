...
import { returnSalesSchema } from "@/types/sales";
...
import { useReturnSales } from "@/hooks/useSales";
...
export default function DataFrom() {
  const { mutate, isPending } = useReturnSales();

  const form = useForm<z.infer<typeof returnSalesSchema>>({
    resolver: zodResolver(returnSalesSchema),
    defaultValues: {
      partyId: 0,
      storageId: 0,
      salesItems: [],
  ...
  function onSubmit(values: z.infer<typeof returnSalesSchema>) {
