!(function () {
  ...
  const Kt = () => Wt(),
    ...
    sn = function (e, t, n, o) {
      (o = o || this),
        e && (n && (e = e[n]), mt(e, (e, r) => !1 !== t.call(o, e, r, n) && (sn(e, t, n, o), !0)));
    },
    an = {
      trim: rn,
      isArray: ut,
        ...
        return ((e, t) => {
          ...
          return n.collapsed
            ? t
                ...
                .map((e) =>
                  hn.rtl(mn(e.endContainer), e.endOffset, mn(e.startContainer), e.startOffset)
                )
  ...
  const Ur = /^[ \t\r\n]*$/,
    ...
    cs = Qr("false"),
    us = (e) =>
      Wr(e) && e.isContentEditable && C(e.parentElement) && !e.parentElement.isContentEditable,
    ms = Yr(["td", "th"]),
    fs = Yr(["td", "th", "caption"]),
    ...
    Ks = (e, t = {}) => {
      ...
      return {
        ...
        loadRawCss: (e, t) => {
          ...
          po(r, { rel: "stylesheet", type: "text/css", id: n.id, "data-mce-key": e }),
            (r.dom.innerHTML = t),
            a(r);
        },
        loadAll: (e) =>
        ...
        if (t) {
          ...
          for (; s--; ) {
            ...
            if (a) {
              ...
              (n && 0 !== a.length) ||
                (delete r[t], $a(e, a.fakeName || t, a.nativeHandler, a.capture));
            }
          }
        } else
          pe(r, (t, n) => {
  ...
  const Ka = an.each,
    ...
    ti = (e, t, n) => {
      ...
      y(n) || "" === n
        ? Uo(e, o)
        : Po(e, o, ((e, t) => (E(e) ? (_e(Ga, t) ? e + "" : e + "px") : e))(n, o));
    },
    ni = (e, t = {}) => {
      const n = {},
        o = window,
  ...
  const ci = N("mce-annotation"),
    ...
    Hi = (e) => {
      const t = e.container();
      return (
        !!es(t) && (t.data.charAt(e.offset()) === Pi || (e.isAtStart() && Ui(t.previousSibling)))
      );
    },
    $i = (e) => {
      const t = e.container();
      return (
        !!es(t) && (t.data.charAt(e.offset() - 1) === Pi || (e.isAtEnd() && Ui(t.nextSibling)))
      );
    },
    ...
    Gi = (e, t) => (
      (e = Xi(e)), t || (e.left = e.left + e.width), (e.right = e.left), (e.width = 0), e
    ),
          ...
          (n = ((e) => {
            const t = [],
              ...
              o = (e, t) => {
                ...
                t > 0 && (o.setStart(e, t - 1), o.setEnd(e, t), Al(o) || n(Bl(Ol(o), !1))),
                  t < e.data.length &&
                    (o.setStart(e, t), o.setEnd(e, t + 1), Al(o) || n(Bl(Ol(o), !0)));
              },
              r = e.container(),
              s = e.offset();
            ...
            if (hl(r))
              if (e.isAtEnd()) {
                ...
                Cl(i) && !xl(i) && (vl(i) || vl(a) || !Cl(a)) && n(Bl(Ol(i), !1)),
                  Cl(a) && n(Bl(Ol(a), !0));
              }
            return t;
          })(Pl(e, t))),
  ...
  const Dl = (e, t) => {
    ...
    zl = (e) =>
      e
        ? pt(
            e.childNodes,
            (e, t) => (Il(t) && "BR" !== t.nodeName ? (e = e.concat(zl(t))) : e.push(t), e),
            []
          )
        : [],
    jl = (e) => (t) => e === t,
    ...
    $l = (e, t) => {
      ...
      return (
        (a = gt(a, O(Gr))), (o = o.concat(ft(a, (e) => Hl(e)))), o.reverse().join("/") + "," + n
      );
    },
    Vl = (e, t) => {
      if (!t) return null;
        ...
        i.push(
          n
            ? ((e, t, n) => {
                ...
                for (let n = t.previousSibling; n && es(n); n = n.previousSibling)
                  o += e(n.data).length;
                return o;
              })(t, s, a)
            : a
    ...
    cm = fl,
    um = (e) =>
      cl(e) || ((e) => !!gl(e) && !G(ce(e.getElementsByTagName("*")), (e, t) => e || sl(t), !1))(e),
    mm = pl,
    ...
    Dm = (e, t) => (
      qr(t) && e.isBlock(t) && !t.innerHTML && (t.innerHTML = '<br data-mce-bogus="1" />'), t
    ),
    Lm = (e, t) =>
      Nm(e).fold(
        L,
  ...
  const qm = (e) => "" !== e && -1 !== " \f\n\r\t\v".indexOf(e),
    ...
    lf = (e, t) => {
      ...
      if (
        ...
        if (a < i.length) {
          ...
          (d = new Fr(t, null !== (o = e.getParent(t, e.isBlock)) && void 0 !== o ? o : l)),
            d.next(!0);
        }
    ...
    vf = (e, t) => {
      ...
      return (
        e.getParent(
          t,
          (t) => !!qr(t) && ((n = e.getStyle(t, "text-decoration")), !!n && "none" !== n)
        ),
        n
      );
    },
    ...
    Uf = (e, t, n, o, r, s) => {
      ...
      for (; a; ) {
        ...
        for (let t = a[i]; t; t = t[i]) {
          ...
          if (
            !Nf(t) &&
            (!as((d = t)) || !d.getAttribute("data-mce-bogus") || d.nextSibling) &&
            !Af(t, n)
          )
            return a;
        }
  ...
  const cg = ni.DOM,
    ...
    mg = (e, t) => {
      const n = hc(e),
        o = cg.getParent(
          t,
          (t) => ((e) => qr(e) && rg.isEditorUIElement(e))(t) || (!!n && e.dom.is(t, n))
        );
      return null !== o;
    },
    fg = (e) => {
    ...
    hg = (e, t) => {
      ((e, t) =>
        ((e) => (e.collapsed ? I.from(nl(e.startContainer, e.startOffset)).map(mn) : I.none()))(
          t
        ).bind((t) => (Ri(t) ? I.some(t) : wn(e, t) ? I.none() : I.some(e))))(mn(e.getBody()), t)
        .bind((e) => km(e.dom))
        .fold(
          () => {
      ...
      e.inline
        ? ((e) => {
            ...
            return (
              t &&
              ((n = mn(t)),
              ro(n) || ((o = n), so(Yn(o)).filter((e) => o.dom.contains(e.dom))).isSome())
            );
            var n, o;
          })(e)
    ...
    Dg = (e, t, n, o) => {
      ...
      if (
        (qr(i) && l > i.childNodes.length - 1 && (u = !1), rs(i) && ((i = r), (l = 0)), i === r)
      ) {
  ...
  const Pp = ["font", "text-decoration", "text-emphasis"],
    ...
    Gp = zp(!1, Hp),
    Zp = (e, t) =>
      ((e, t, n) => (wn(t, e) ? In(e, (e) => n(e) || Cn(e, t)).slice(0, -1) : []))(e, t, L),
    ...
    ch = (e, t, n) =>
      ((e) => I.from(e.getNode(!0)).map(mn))(t).exists(_i) || lh(!1, e, t, n).isSome(),
    uh = T(lh, !1),
    mh = T(lh, !0),
        ...
        e
          ? ((e, t) =>
              Dh(t)
                .orThunk(() => Ph(t))
                .orThunk(() =>
                  ((e, t) => _m(e, Pl.after(t)).orThunk(() => Sm(e, Pl.before(t))))(e, t)
                ))(t, n)
          : ((e, t) =>
              Ph(t)
                .orThunk(() => Dh(t))
    ...
    lb = (e) => (t) =>
      ib(t, e).map((e) => ((e, t, n) => ({ rng: e, table: t, cells: n }))(t, e, tb(e))),
    db = (e, t, n, o) => {
    ...
    cb = (e, t) => J(e, (e) => Cn(e, t)),
    ub = (e) =>
      ze(cb(e.cells, e.rng.start), cb(e.cells, e.rng.end), (t, n) => e.cells.slice(t, n + 1)),
    mb = (e, t) => {
        ...
        const o = e.selection.getRng(),
          r = n
            .bind(({ rng: n, isStartInTable: r }) => {
              ...
              return (
                pb(e, a, o, r), xs(e.schema, a) ? I.none() : I.some(r ? t.slice(1) : t.slice(0, -1))
              );
            })
            .getOr(t);
        gb(r), hb(e);
            ...
            return 0 !== n.length
              ...
              : ((e, t, n, o) =>
                  Eb(t, o).fold(
                    () =>
                      ((e, t, n) =>
                        fb(t, n).bind((t) => t.fold(T(yb, e), T(Cb, e), T(bb, e), T(vb, e))))(
                        e,
                        t,
                        n
                      ),
              ...
              if (
                ...
                const n = Dp(o, e),
                  ...
                  d = (t) =>
                    ...
                    o.is(t, s) &&
                    a(t) &&
                    ((t.nodeName === e.nodeName && l(n, Dp(o, t))) || d(t.children[0])),
                  ...
                  u = (n) =>
                    ...
                    (((e, t, n) => {
                      ...
                      u(n.parentElement));
                (d(e.children[0]) || (c(e.parentElement) && !u(e.parentElement))) &&
                  o.remove(e, !0);
              }
              var l;
            });
    ...
    uv = (e) => {
      const t = cn("span");
      return (
        po(t, { id: Rm, "data-mce-bogus": "1", "data-mce-type": "format-caret" }),
        e && co(t, un(dv)),
        t
      );
    },
  ...
  const _v = ["fontWeight", "fontStyle", "color", "fontSize", "fontFamily"],
    ...
    Nv = (e, t) =>
      !1 === _m(t, Pl.fromRangeEnd(e)).exists((e) => !as(e.getNode()) || _m(t, e).isSome()),
    ...
    Kv = (e, t, n) => {
      ...
      wf(n) &&
        ...
        (((e) => Ef(e) && xf(e) && Fe(xe(e, "mixed"), !0))(n) && !jv(n.inline, t)) ||
          s.remove(t, !0);
    },
    ...
    Gv = (e, t, n, o, r) => {
      ...
      zv(n.styles, (a, i) => {
        const { name: l, value: d } = Yv(i, a, o),
          c = hf(d, l);
        (n.remove_similar || h(d) || !qr(r) || jv(bf(e, r, l), c)) && e.setStyle(t, l, ""),
          (s = !0);
      }),
        s && Xv(e, t);
    },
    Zv = (e, t, n, o, r) => {
      const s = e.dom,
        a = Tb(e),
        i = e.schema;
      if (xf(t) && Us(i, t.inline) && js(i, o) && o.parentElement === e.getBody())
              ...
              if (a.split) {
                if (((r = Ig(r)), (n = $v(e, r, !0)), (o = $v(e, r)), n !== o)) {
                  if (((n = Vv(n, !0)), (o = Vv(o, !1)), Hv(i, n, o))) {
                    ...
                    return (
                      d(Wv(i, e, !0, "span", { id: "_start", "data-mce-type": "bookmark" })),
                      void m(!0)
                    );
                  }
                  if (Hv(i, o, n)) {
                    ...
                    return (
                      d(Wv(i, e, !1, "span", { id: "_end", "data-mce-type": "bookmark" })),
                      void m(!1)
                    );
                  }
            ...
            const p = (a) => {
              ...
              if (
                ...
                !((e, t, n, o) => {
                  if (gc(e) && xf(t) && n.parentNode) {
                    ...
                    return (
                      Se(t, o) &&
                      Es(e.schema, n.parentNode, { skipBogus: !1, includeZwsp: !0 }) &&
                      !r
                    );
                  }
                  return !1;
              ...
              if (((o) => ((e) => wf(e) && !0 === e.wrapper)(s) && iv(e, o, t, n))(a)) u = null;
                ...
                if (
                  ((t, n, o) => {
                    const r =
                      ((e) => wf(e) && !0 !== e.wrapper)(s) && cf(e.schema, t) && uf(e, n, f);
                    return o && r;
                  })(a, w, x)
                ) {
                  ...
                  (s.exact ||
                    ...
                    (a = ((e) => {
                      const t = Q(e.childNodes, sf).filter(
                        (e) => "false" !== o.getContentEditable(e) && sv(o, e, s)
                      );
                      return t
                        .map((t) => {
                          const n = o.clone(t, !1);
                  ...
                  ((e, t, n, o) => {
                    if (t.styles && t.styles.backgroundColor) {
                      ...
                      Lv(
                        ...
                        Iv(e, "backgroundColor", gf(t.styles.backgroundColor, n))
                      );
                    }
                  })(o, s, n, a),
                  ((e, t, n, o) => {
  ...
  var _C = (function e() {
    ...
    n.isSupported =
      "function" == typeof Sy && "function" == typeof C && x && void 0 !== x.createHTMLDocument;
    const {
      MUSTACHE_EXPR: A,
      ERB_EXPR: T,
      TMPLIT_EXPR: O,
        ...
        return e instanceof d &&
          ...
          : ("noscript" !== o && "noembed" !== o && "noframes" !== o) ||
            ...
            ? (X &&
                ...
                e.textContent !== t &&
                  (Fy(n.removed, { element: e.cloneNode() }), (e.textContent = t))),
  ...
  const LC = (e, t, n, o, r) => {
      ...
      const n = my(),
        ...
        a = ((e, t) => {
          const n = (() => {
            ...
            return {
              track: (n) => (
                Ns(n) ? e.set(n) : e.get().exists((e) => !e.contains(n)) && e.clear(), t()
              ),
              current: t,
              reset: () => {
                e.clear();
                ...
                ((e, n) => {
                  ...
                  if (t.isValidChild(e.name, n.toLowerCase())) {
                    for (; i; ) {
                      ...
                      g(o, i)
                        ? (l ||
                            ((l = new up(n, 1)), l.attr(r.forced_root_block_attrs), e.insert(l, i)),
                          l.append(i))
                        : (d(l), (l = null)),
                        (i = t);
                    }
          ...
          t.validate &&
            ...
            ((e, t) => {
              ...
              if (n) {
                const t = (e) => {
                  const t = e.attr("src");
                  ((e) => e.attr("src") === nn.transparentSrc || C(e.attr("data-mce-placeholder")))(
                    e
                  ) ||
    ...
    KC = (e, t, n) => {
      ...
      if (ev(e)) {
        if (r.content !== o) {
          const t = WC({ validate: !1, forced_root_block: !1, ...n }).parse(r.content, {
            context: e.name,
          });
          return { ...r, content: t };
        }
    ...
    ww = (e, t) =>
      !(!e || !t) && (!!((e, t) => yw(e) === yw(t))(e, t) || ((e, t) => Cw(e) === Cw(t))(e, t)),
    Ew = (e) => 0 === e.get(),
    xw = (e, t, n) => {
      Ew(n) && (e.typing = t);
    },
    ...
    Sw = (e) => ({
      ...
      undoManager: {
        ...
        hasUndo: (t, n) =>
          ((e, t, n) => n.get() > 0 || (t.typing && t.data[0] && !ww(bw(e), t.data[0])))(e, t, n),
        hasRedo: (e, t) => ((e, t) => t.get() < e.data.length - 1 && !e.typing)(e, t),
        transact: (e, t, n) =>
          ((e, t, n) => (_w(e, t), e.beforeChange(), e.ignore(n), e.add()))(e, t, n),
        ignore: (e, t) =>
          ((e, t) => {
            try {
              e.set(e.get() + 1), t();
          ...
          ((e, t) => {
            ...
            return I.from(e.selection.getStart(!0))
              .bind((o) =>
                xr(
                  mn(o),
                  (n) => ue(t, (t) => ((t, n) => (iv(e, t.dom, n) ? I.some(n) : I.none()))(n, t)),
                  n
                )
              )
              .getOrNull();
      ...
      editor: {
        getContent: (t) =>
          ((e, t) =>
            I.from(e.getBody()).fold(N("tree" === t.format ? new up("body", 11) : ""), (n) =>
              Np(e, t, n)
            ))(e, t),
        setContent: (t, n) =>
          ((e, t, n) =>
    ...
    Ow = (e, t, n, o, r) => {
      e.bind(
        ...
        const e = ((e, t) => e.filter((e) => Yf.isBookmarkNode(e.dom)).bind(t ? Un : Fn))(t, o)
          .or(t)
          .filter(Rn);
        return e.map((e) =>
          ((e, t, n) => {
      ...
      const { selectorChangedWithUnbind: a } = ((e, t) => {
        ...
        c = () => {
          ...
          try {
            ...
            e &&
              !Vr(e.anchorNode) &&
              ((n = e.rangeCount > 0 ? e.getRangeAt(0) : i.createRange()), (n = ap(o, [n])[0]));
          } catch (e) {}
        ...
        f = {
          ...
          getContent: (e) =>
            ((e, t = {}) =>
              ((e, t, n) => Rw(e).selection.getContent(t, n))(e, t.format ? t.format : "html", t))(
              o,
              e
            ),
          setContent: i,
              ...
              I.from(t).bind((t) =>
                I.from(t.parentNode).map((o) => {
                  const r = e.nodeIndex(t),
                    s = e.createRng();
                  return (
                    s.setStart(o, r), s.setEnd(o, r + 1), n && (ef(e, s, t, !0), ef(e, s, t, !1)), s
                  );
                })
              ))(e, t, n).each(u),
            t
    ...
    aE = (e) => {
      const t = [],
        ...
        a = (o, a = !0) =>
          e.removed ||
          !((e) => {
            return ((t = e.inline ? e.getBody() : e.getContentAreaContainer()), I.from(t).map(mn))
              .map(Oo)
              .getOr(!1);
            var t;
          })(e)
                            ...
                            Eo(n),
                              o.each(
                                ((e) => (t) => {
                                  ((e, t) =>
                                    e.dom.isEmpty(t.dom) &&
                                    C(e.schema.getTextBlockElements()[xn(t)]))(e, t) &&
          ...
          (t = e.replace(/(?:([#\.]|::?)([\w\-]+)|(\[)([^\]]+)\]?)/g, (e, t, o, r, s) => {
            switch (t) {
              ...
              case ".":
                ...
                break;
              case ":":
                -1 !== an.inArray("checked disabled enabled read-only required".split(" "), o) &&
                  (n.attrs[o] = o);
            }
            if ("[" === r) {
              const e = s.match(/([\w\-]+)(?:\=\"([^\"]+))?/);
    ...
    $E = (e) => {
      ...
      return (
          ...
          })(n, e),
        {
          ...
          match: (t, n, o, r) =>
            ((e, t, n, o, r) => Rw(e).formatter.match(t, n, o, r))(e, t, n, o, r),
          closest: (t) => ((e, t) => Rw(e).formatter.closest(t))(e, t),
          matchAll: (t, n) => ((e, t, n) => Rw(e).formatter.matchAll(t, n))(e, t, n),
          matchNode: (t, n, o, r) =>
            ((e, t, n, o, r) => Rw(e).formatter.matchNode(t, n, o, r))(e, t, n, o, r),
    ...
    qE = (e) => {
      const t = Ve(),
        ...
        r = {
          ...
          add: (s, a) =>
            ((e, t, n, o, r, s, a) => Rw(e).undoManager.add(t, n, o, r, s, a))(e, r, o, n, t, s, a),
          dispatchChange: () => {
            e.setDirty(!0);
            const t = bw(e);
        ...
        .fold(
          () =>
            ((e, t, n, o) => {
              ...
              (n) => () =>
                n.fold(
                  ((e, t) => (n) => (e._selectionOverrides.hideFakeCaret(), Fh(e, t, mn(n)), !0))(
                    e,
                    t
                  ),
                  ((e, t) => (n) => {
    ...
    Lx = (e, t) =>
      e
        ...
        : ((e) => {
            var t, n;
            if (Ox(e.nextSibling))
              return Bx(e.nextSibling) || e.nextSibling.insertData(0, Pi), e.nextSibling;
  ...
  const A_ = (e, t, n, o, r, s) => {
    ...
    CS = (e, t, n) =>
      ue([yS, _x, hx, (e, n) => J_(e, t, n), ax, kb, Tx, uS, dx, lS, Ax], (t) => t(e, n)).filter(
        (t) => e.selection.isEditable()
      ),
    wS = (e) => (void 0 === e.touches || 1 !== e.touches.length ? I.none() : I.some(e.touches[0])),
    ES = (e, t) => _e(e, t.nodeName),
    xS = (e, t) =>
      !!es(t) || (!!qr(t) && !(ES(e.getBlockElements(), t) || Hm(t) || js(e, t) || Ns(t))),
    _S = (e, t) => {
      if (es(t)) {
    ...
    VS = (e, t) =>
      Q(
        ((e, t) => te(((e) => V(e, (e) => ({ ...jS, ...e })))(e), (e) => (HS(e, t) ? [e] : [])))(
          e,
          t
        ),
        (e) => e.action()
      ...
      return ((e, t) =>
        ((e, t, n = L) =>
          n(t)
            ...
            : H(e, xn(t))
              ? I.some(t)
              : or(t, e.join(","), (e) => vn(e, "table") || n(e)))(["td", "th"], e, t))(
        mn(t ? s.endContainer : s.startContainer),
        r
      )
        .map(
          (n) => (
  ...
  const pN = (e) => ({ tag: "defaultedThunk", process: N(e) }),
          ...
          e.fold(
            ...
            (e) => {
              ...
              return (
                (s = n),
                (a = I.some),
                s.stype === Jk.Value ? { stype: Jk.Value, svalue: a(s.svalue) } : s
              );
              var s, a;
            }
          );
        ...
        case "required":
          return ((e, t, n, o) =>
            xe(t, n).fold(
              () =>
                ((e, t, n) =>
                  sN(e, () => 'Could not find valid *required* value for "' + t + '" in ' + rN(n)))(
                  e,
                  n,
                  t
                ),
    ...
    wN = (e, t, n) => {
      return (
        (o = ((e, t, n) =>
          ((e, t) => (e.stype === Jk.Error ? { stype: Jk.Error, serror: t(e.serror) } : e))(
            t.extract([e], n),
            (e) => ({ input: n, errors: e })
          ))(e, t, n)),
  ...
  const HN = AN("meta", {});
  PN("onAction", _),
    CN([(() => TN("type", "autocompleteitem", uN))(0, "autocompleteitem"), zN, jN, HN, LN, FN, UN]);
  const $N = CN([
    DN,
    _N("trigger"),
    ON("minChars", 1),
  ...
  const WN = (e) => {
        ...
        a = (a) => {
          ((n) =>
            t
              .get()
              .map((t) =>
                Xk(e.dom, e.selection.getRng(), t.trigger, !0).bind((t) => Qk(e, s, t, n))
              )
              .getOrThunk(() =>
                ((e, t) => {
                  const n = t(),
                    o = e.selection.getRng();
                  return ((e, t, n) => ue(n.triggers, (n) => Xk(e, t, n)))(e.dom, o, n).bind((n) =>
                    Qk(e, t, n)
                  );
                })(e, s)
              ))(a).fold(r, (r) => {
        ...
        : n
          ? ((e, t) =>
              t.startSummary.exists((t) =>
                ((e, t) =>
                  Nm(t).exists(
                    (n) => (as(n.getNode()) && Sm(t, n).exists((t) => t.isEqual(e))) || n.isEqual(e)
                  ))(e, t)
              ))(s, t) ||
            ((e, t, n) =>
              n.startDetails.exists((n) => _m(e, t).forall((e) => !n.contains(e.container()))))(
              a,
              s,
              t
            )
          : ((e, t) =>
              t.startSummary.exists((t) => ((e, t) => km(t).exists((t) => t.isEqual(e)))(e, t)))(
              s,
              t
            ) ||
            ((e, t) =>
      ...
      insert: (e, t) => {
        ...
        const i = e.dom,
          ...
          v = (e) => {
            ...
            let s;
            for (
              es(n) && (e && 0 === t ? r.prev() : e || t !== n.data.length || r.next());
              (s = r.current());
            ...
            ((e, t, n) =>
              ...
              ((t, n) => {
                ...
                for (; o && o !== t && h(o.nextSibling); ) {
                  ...
                  if (
                    !t ||
                    ((r = t), !_e(e.schema.getTextBlockElements(), r.nodeName.toLowerCase()))
                  )
                    return hs(t);
                  o = t;
                }
        ...
        if (p)
          ...
          ((e) => {
            ...
            ((e, t) => {
              t.normalize();
              const n = t.lastChild;
              (!n || (qr(n) && /^(left|right)$/gi.test(e.getStyle(n, "float", !0)))) &&
                e.add(t, "br");
            })(i, S),
            i.isEmpty(S) && gR(S),
            R.normalize(),
              ...
              "LI" !== u || m || (d = c),
                es(l) &&
                  ...
                  (((e, t, n) => {
                    ...
                    for (; (r = o.next()); )
                      if (s[r.nodeName.toLowerCase()] || (es(r) && r.length > 0)) return !0;
                    return !1;
    ...
    oA = (e, t, n) => {
      n && !e.get() ? t.on("NodeChange", tA, !0) : !n && e.get() && t.off("NodeChange", tA),
        e.set(n);
    },
    ...
    dA = (e) => {
      ...
      if (e.selection.isCollapsed()) {
        ...
        return Zx(o, e.getBody(), r)
          ...
          .map(
            (o) => () =>
              ((e, t, n) => (o) => (yh(e, o, n) ? aA(t) : iA(t)))(n, t, e.schema)(o).each(lA(e))
          );
      }
      return I.none();
    },
  ...
  const gA = "x-tinymce/html",
    ...
    BA = (e, t, n, o, r) => {
      ...
      if (!s.cancelled) {
        ...
        r
          ? aR(e, "insertFromPaste", { dataTransfer: OA(t) }).isDefaultPrevented() ||
            (n(), sR(e, "insertFromPaste"))
          : n();
      }
    },
    PA = (e, t, n, o) => {
    ...
    FA = (e, t, n) => {
      ...
      if (jc(e) && o) {
        ...
        if (s.length > 0)
          return (
            t.preventDefault(),
            ((r = s), Promise.all(V(r, (e) => hy(e).then((t) => ({ file: e, uri: t }))))).then(
              (t) => {
    ...
    zA = (e, t, n) => {
      ((e, t, n) => {
        let o;
        e.on("keydown", (e) => {
          ((e) => (wg.metaKeyPressed(e) && 86 === e.keyCode) || (e.shiftKey && 45 === e.keyCode))(
            e
          ) &&
            !e.isDefaultPrevented() &&
      ...
      ((e) => {
        ...
        ((e, t) => {
          e.addCommand("mceTogglePlainTextPaste", () => {
            ((e, t) => {
              "text" === t.get() ? (t.set("html"), gd(e, !1)) : (t.set("text"), gd(e, !0)),
                e.focus();
            })(e, t);
          }),
    ...
    oT = (e) => {
      const t = ((e, t, n) => {
        const o = Pl.fromRangeStart(e).getNode(),
          r = ((e, t, n) =>
            tr(mn(e), (e) => ((e) => ds(e.dom))(e) || n.isBlock(xn(e)), eT(t)).getOr(mn(t)).dom)(
            o,
            t,
            n
          ),
  ...
  const sT = (e, t) => Math.abs(e.left - t),
    ...
    dT = (e, t, n, o) => {
      const r = (e) =>
          fl(e.node) ? I.some(e) : qr(e.node) ? dT(ce(e.node.childNodes), t, n, !1) : I.none(),
        s = (e, s) => {
          const a = ae(e, (e, o) => s(e, t, n) - s(o, t, n));
          return ue(a, r).map((e) =>
            o && !es(e.node) && a.length > 1
              ? ((e, o, s) =>
                  r(o).filter((o) => Math.abs(s(e, t, n) - s(o, t, n)) < 2 && es(o.node)))(
                  e,
                  a[1],
                  s
                ).getOr(e)
    ...
    cT = (e, t, n) =>
      ((e, t, n) => {
        ...
        .filter((e) => Bu(e.node))
        .map((e) =>
          ((e, t) => ({ node: e.node, position: sT(e, t) < aT(e, t) ? rT.Before : rT.After }))(e, t)
        ),
    uT = (e) => {
      var t, n;
    ...
    fT = (e, t, n, o) => {
      const r = ((e, t) => {
        ...
        return (
          "dragstart" === t ? (rk(n), uk(n)) : "drop" === t ? (sk(n), mk(n)) : (ak(n), fk(n)), n
        );
      })(n, e);
      return v(o)
        ? ((e, t, n) => {
    ...
    TT = (e) => {
      ...
      let i;
      const l = (e) =>
          e !== o && (RT(e) || gs(e)) && n.isChildOf(e, o) && n.isEditable(e.parentNode),
        d = (n, o, s, a = !0) =>
                  ...
                  const t = (t) => {
                      if (!t.isDefaultPrevented()) {
                        ...
                        n &&
                          ...
                          (t.preventDefault(),
                          "drop" === t.type && uE(e, "Dropped file type is not supported"));
                      }
                    },
                    n = (n) => {
                      mg(e, n.target) && t(n);
    ...
    KT = (e, t, n, o) => {
      ...
      return Vk(i, l - n.pattern.end.length, t).bind((d) => {
          ...
          return I.some({ matches: [{ pattern: a, startRng: c, endRng: c }], position: d });
        {
          ...
          return m.map((e) => {
            const t = ((e, t, n, o = !1) =>
              PT(e, t, n.startContainer, n.startOffset, n.endContainer, n.endOffset, o))(
              r,
              s,
              e,
              o
                ...
                if ((qr(m) && Is(o, m), xS(o, m))) {
                  ...
                  if (!i) {
                    if (
                      (!d &&
                        e.hasFocus() &&
                        (d = Nx(e.selection.getRng(), () => document.createElement("span"))),
                      !m.parentNode)
                    ) {
                      m = null;
                      break;
              ...
              if (
                ((e) => {
                  if (YE(e)) {
                    ...
                    return (
                      !XE(e) &&
                      (wg.metaKeyPressed(e) || e.altKey || (t >= 112 && t <= 123) || H(WE, t))
                    );
                  }
                  return !1;
                })(t)
        ...
        ((e) => {
          ...
          if (m(t)) {
            ...
            (e.theme = n(e, lE.urls[t]) || {}),
              w(e.theme.init) &&
                e.theme.init(e, lE.urls[t] || e.documentBaseUrl.replace(/\/$/, ""));
          } else e.theme = {};
        })(e),
        ((e) => {
          const t = dc(e),
                ...
                (s.onload = () => {
                  ...
                  (e.iframeHTML = ((e) => {
                    ...
                    return (
                      Nd(e) &&
                        (t +=
                          '<meta http-equiv="Content-Security-Policy" content="' + Nd(e) + '" />'),
        ...
        .bind((n) =>
          ((e, t, n) =>
            xr(
              ...
              (t) =>
                ((t) =>
                  Io(t, e).orThunk(() => (HO(t) ? xe(jO, e).bind((e) => bo(t, e)) : I.none())))(t),
              (e) => Cn(mn(t), e)
        ...
        : yE(e) &&
          ((e, t) => {
            if (((e) => "click" === e.type)(t) && !wg.metaKeyPressed(t)) {
              const n = mn(t.target);
              ((e, t) => sr(t, "a", (t) => Cn(t, mn(e.getBody()))).bind((e) => bo(e, "href")))(
                e,
                n
              ).each((n) => {
        ...
        "focus" !== e &&
          ...
          (n.removed ||
            (t
              ...
              : n.initialized &&
                n.delegates &&
                (n.dom.unbind(iB(n, e), e, n.delegates[e]), delete n.delegates[e])));
      },
  ...
  class AB {
      ...
      ((e) => {
        ...
        e.on("remove", () => {
          ...
          (e.ui.styleSheetLoader = ((e, t) =>
            Ys.forElement(e, { contentCssCors: kc(t), referrerPolicy: Wd(t) }))(o, e)),
          bc(e)
            ? (e.inline = !0)
    ...
    getContainer() {
      const e = this;
      return (
        e.container || (e.container = e.editorContainer || kB.get(e.id + "_parent")), e.container
      );
    }
